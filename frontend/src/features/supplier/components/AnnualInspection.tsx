...
const AnnualInspection: React.FC = () => {
  useDocumentTitle('供应商年检 - 供应商管理');

  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">供应商年检</h1>
          <p className="text-gray-500 mt-1">管理供应商年度检查记录</p>
        </div>
